...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	//trata todos os erros nas classes apontadas, runtime, exceotin, throwable,
	//que podem ocorrer durante o processamento das solicitações HTTP
	...
	//Este método é outro manipulador de exceção em um controlador Spring,
	//mas ele é específico para lidar com exceções relacionadas a violações de integridade de dados, update, delete...
